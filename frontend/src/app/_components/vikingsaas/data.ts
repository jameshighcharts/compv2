...
export const PANEL_META: Record<string, { title: string; description: string }> = {
  "arr-growth":  { title: "ARR Growth Analysis",       description: "Total, Organic & New Sales ARR waterfall bridges + peer benchmarks" },
  "churn":       { title: "Churn Analysis",            description: "Monthly annualised churn by customer size and industry vertical" },
  ...
  "concentration":{ title: "Revenue Concentration",   description: "Customer and industry ARR concentration + trend analysis" },
